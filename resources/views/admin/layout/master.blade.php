...
<html>
  <head>
    ...
    <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
        ...
        <!-- iCheck -->
        <link rel="stylesheet" href="{{URL::asset('admin/plugins/iCheck/flat/blue.css')}}" type="text/css">
        <!-- Morris chart -->
        <link rel="stylesheet" href="{{URL::asset('admin/plugins/morris/morris.css')}}" type="text/css">
        <!-- jvectormap -->
